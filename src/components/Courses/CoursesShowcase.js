...
class CoursesShowcase extends Component {
  // get list of courses from constructor param and loop in render method.
      ...
      <section className="showcase">
        <div className="container-fluid p-0">
          <div className="row no-gutters">
            <div
              className="col-lg-6 order-lg-2 text-white showcase-img si1"></div>
          ...
          <div className="row no-gutters">
            <div
              className="col-lg-6 text-white showcase-img si2"></div>
          ...
          <div className="row no-gutters">
            <div
              className="col-lg-6 order-lg-2 text-white showcase-img si3"></div>
            <div className="col-lg-6 order-lg-1 my-auto showcase-text">
